...
class InformationResource : public PublicApiResource
{
    ...
    protected :
        ...
        EReturnCode getPluginsListForInformation(const std::vector<std::string> &pathElements, const long long &orgId, std::string &responseMsg);
