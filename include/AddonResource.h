...
class AddonResource : public PublicApiResource
{
    ...
    protected :
        EReturnCode getAddonsList(const long long &grpId, std::string &responseMsg);
        EReturnCode getAddon(const std::vector<std::string> &pathElements, const long long &grpId, std::string &responseMsg);
        EReturnCode getSearchTypeForAddon(const std::vector<std::string> &pathElements, const long long &grpId, std::string& responseMsg);
