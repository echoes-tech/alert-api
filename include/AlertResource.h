...
//        EReturnCode getTrackingAlertList(const long long &orgId, std::string &responseMsg);
        EReturnCode getAlertsList(const long long &orgId, std::string &responseMsg, const std::vector<std::string> &pathElements = std::vector<std::string>(), const std::string &sRequest = NULL, std::map<string, long long> parameters = map<string, long long>());
        EReturnCode getAlert(const long long &orgId, std::string &responseMsg, const std::vector<std::string> &pathElements = std::vector<std::string>(), const std::string &sRequest = NULL, std::map<string, long long> parameters = map<string, long long>());
...
//        );
        ...
        EReturnCode postAlert(const long long &orgId, std::string &responseMsg, const std::vector<std::string> &pathElements = std::vector<std::string>(), const std::string &sRequest = NULL, std::map<string, long long> parameters = map<string, long long>());
...
//        virtual EReturnCode processPutRequest(const Wt::Http::Request &request, const long long &orgId, std::string &responseMsg);
        ...
        EReturnCode deleteAlert(const long long &orgId, std::string &responseMsg, const std::vector<std::string> &pathElements = std::vector<std::string>(), const std::string &sRequest = NULL, std::map<string, long long> parameters = map<string, long long>());
        virtual EReturnCode processDeleteRequest(const Wt::Http::Request &request, const long long &orgId, std::string &responseMsg);
        
        EReturnCode Error       (const long long &orgId, std::string &responseMsg, const std::vector<std::string> &pathElements = std::vector<std::string>(), const std::string &sRequest = NULL, std::map<string, long long> parameters = map<string, long long>());
