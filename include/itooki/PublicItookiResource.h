/* 
 * Header of public itooki Resource
...
#ifndef PUBLICITOOKIRESOURCE_H
#define	PUBLICITOOKIRESOURCE_H
...
class PublicItookiResource : public Wt::WResource {
public:
    PublicItookiResource(Echoes::Dbo::Session& session);
    virtual ~PublicItookiResource();
