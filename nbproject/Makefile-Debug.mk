...
${OBJECTDIR}/src/PublicItookiResource.o: src/PublicItookiResource.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I../dbo/include -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PublicItookiResource.o src/PublicItookiResource.cpp
...
${OBJECTDIR}/src/PublicItookiResource_nomain.o: ${OBJECTDIR}/src/PublicItookiResource.o src/PublicItookiResource.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Iinclude -I../dbo/include -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PublicItookiResource_nomain.o src/PublicItookiResource.cpp;\
	else  \
