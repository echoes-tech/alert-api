...
${OBJECTDIR}/src/SearchTypeResource.o: src/SearchTypeResource.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SearchTypeResource.o src/SearchTypeResource.cpp
...
${OBJECTDIR}/src/SearchTypeResource_nomain.o: ${OBJECTDIR}/src/SearchTypeResource.o src/SearchTypeResource.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -s -Iinclude -I../dbo/include -I/var/lib/jenkins/jobs/ea-dbo-${target}/workspace/include -std=c++11 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SearchTypeResource_nomain.o src/SearchTypeResource.cpp;\
	else  \
